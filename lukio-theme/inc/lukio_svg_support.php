...
class Lukio_SVG_Support
{
    ...
    private static $whitelist = array(
        ...
        "svg" => array("class", "clip-path", "clip-rule", "filter", "id", "height", "mask", "preserveAspectRatio", "requiredFeatures", "style", "systemLanguage", "viewBox", "width", "x", "xmlns", "xmlns:se", "xmlns:xlink", "y", 'fill', 'stroke', 'stroke-width', 'stroke-linecap'),
