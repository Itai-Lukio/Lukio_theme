...
if (!function_exists('lukio_footer_credit')) {
     ...
     * @author Itai Dotan
     */
    function lukio_footer_credit($dark_mode = false)
    {
        $link = 'https://lukio.pro';
        $mode = $dark_mode ? 'dark_mode' : 'light_mode';
        $svg = '<svg id="lukio_credit_svg" aria-label="Lukio logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107.87 40.12"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="lukio_footer_svg_u" d="M24.14,29c-7.8,0-13-5-13-12.47V1h9.68V16.57c0,2.39,1.1,3.56,3.36,3.56s3.52-1.22,3.52-3.61V1h9.68V16.57C37.34,24,32,29,24.14,29Z" fill="{{lukio_footer_svg_u}}"/><path class="lukio_footer_svg_u_border" d="M36.34,2V16.57C36.34,23.29,31.73,28,24.15,28s-12-4.75-12-11.47V2h7.68V16.57c0,3,1.58,4.56,4.37,4.56s4.51-1.59,4.51-4.61V2h7.68m2-2H26.66V16.52c0,1.85-.73,2.61-2.51,2.61-1.43,0-2.37-.44-2.37-2.56V0H10.1V16.57C10.1,24.63,15.74,30,24.15,30s14.19-5.41,14.19-13.47V0Z" fill="{{lukio_footer_svg_u_border}}"/><path class="lukio_footer_svg_text" d="M93.93,12.18a13.55,13.55,0,0,0-14,14,13.95,13.95,0,1,0,27.89,0C107.87,17.86,101.84,12.2,93.93,12.18Zm0,19.9a5.93,5.93,0,0,1,0-11.86,5.93,5.93,0,1,1,0,11.86Z" fill="{{lukio_footer_svg_text}}"/><polygon class="lukio_footer_svg_text" points="76.7 12.81 69.02 12.81 69.02 39.4 76.7 39.4 76.7 39.4 76.7 39.4 76.7 12.81 76.7 12.81 76.7 12.81" fill="{{lukio_footer_svg_text}}"/><polygon class="lukio_footer_svg_text" points="7.68 2.08 0 2.08 0 32.2 0 39.4 7.68 39.4 35.95 39.4 35.95 32.2 7.68 32.2 7.68 2.08" fill="{{lukio_footer_svg_text}}"/><polygon class="lukio_footer_svg_text" points="67.11 12.81 58.03 12.81 48.38 25 48.38 2.08 40.7 2.08 40.7 39.4 48.38 39.4 48.38 26.54 58.03 39.4 67.44 39.4 56.74 25.48 67.11 12.81" fill="{{lukio_footer_svg_text}}"/><path class="lukio_footer_svg_text" d="M72.89,10.3a4.15,4.15,0,1,0-4.23-4.17A4.14,4.14,0,0,0,72.89,10.3Z" fill="{{lukio_footer_svg_text}}"/></g></g></svg>';
        $colors_set = $dark_mode ? array('#4AA896', 'transparent', '#FFFFFF') : array('#4AA896', '#302D2E', '#302D2E');
        $svg = str_replace(['{{lukio_footer_svg_u}}', '{{lukio_footer_svg_u_border}}', '{{lukio_footer_svg_text}}'], $colors_set, $svg);

        echo '<a id="lukio_credit" class="' . $mode . '" href="' . $link . '" target="_blank">' . __('Developed & Powered by', 'lukio-theme') . $svg . '</a>';
    }
}
